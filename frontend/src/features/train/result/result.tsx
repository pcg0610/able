...
const Data = {
   ...
   epoch_result: [
      ...
      },
      {
         ...
         accuracies: { accuracy: 0.90 }
      },
      {
         epoch: "40",
         losses: { training: 0.10, validation: 0.16 },
      ...
      {
         epoch: "80",
         losses: { training: 0.20, validation: 0.12 },
      ...
      {
         epoch: "100",
         losses: { training: 0.24, validation: 0.10 },
      ...
      {
         epoch: "150",
         losses: { training: 0.30, validation: 0.05 },
         accuracies: { accuracy: 0.99 }
      }
   ]
};
